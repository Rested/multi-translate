...
* <pre>
* var MultiTranslateClient = require('index'); // See note below*.
* var xxxSvc = new MultiTranslateClient.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new MultiTranslateClient.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new MultiTranslateClient.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new MultiTranslateClient.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
