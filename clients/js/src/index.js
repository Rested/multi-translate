...
* <pre>
* var MultiTranslate = require('index'); // See note below*.
* var xxxSvc = new MultiTranslate.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new MultiTranslate.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new MultiTranslate.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new MultiTranslate.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
