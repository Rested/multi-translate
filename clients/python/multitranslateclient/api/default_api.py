...
class DefaultApi(object):
    ...
    def get_supported_engines_available_engines_get(self, **kwargs):  # noqa: E501
        """Get Supported Engines  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_supported_engines_available_engines_get(async_req=True)
        >>> result = thread.get()
        ...
        return self.get_supported_engines_available_engines_get_with_http_info(**kwargs)  # noqa: E501

    def get_supported_engines_available_engines_get_with_http_info(self, **kwargs):  # noqa: E501
        """Get Supported Engines  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_supported_engines_available_engines_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method get_supported_engines_available_engines_get" % key
                )
    ...
    def get_supported_languages_supported_languages_get(self, **kwargs):  # noqa: E501
        """Get Supported Languages  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_supported_languages_supported_languages_get(async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_supported_languages_supported_languages_get_with_http_info(**kwargs)  # noqa: E501

    def get_supported_languages_supported_languages_get_with_http_info(self, **kwargs):  # noqa: E501
        """Get Supported Languages  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_supported_languages_supported_languages_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_supported_languages_supported_languages_get" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
